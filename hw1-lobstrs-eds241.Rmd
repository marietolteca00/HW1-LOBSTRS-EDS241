...
- non-mpa: The model estimate that there is a reduction of 19% lower abundance compared to mpa sites.
...
- I do not think spillover effects are likely in this study because the MPA treatment in one site is unlikely to directly affect lobster abundance in nearby non-MPA sites. Each site’s lobster population is largely independent, so the treatment effect is isolated. 
...
d. Discuss the following causal inference assumptions in the context of the MPA treatment effect estimator. Evaluate if each of the assumption are reasonable: 
    ...
    - The SUTVA assumption appears reasonable in this study. Lobster abundance in each site is unlikely to be affected by the treatment status of other sites(no inference), and the MPA management was applied consistently across treated sites(no hidden variation).
