...
```
- Intercept: On average, surveys conducted at Marine Protected Area reefs recorded about 28 lobsters per site.

- non-mpa: Non-MPA reefs had, on average, about 3 fewer lobsters per site compared to a control reef.
```
```{r}
...
- Intercept: On average, the model estimates about 23 lobsters at non-treated (non-MPA) sites.
- Treatment: On average, treated (MPA) sites have about five more lobsters than non-MPA sites.
